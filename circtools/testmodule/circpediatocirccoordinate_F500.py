...
#    print("--------------")
    ...
    i += i
"""
wb = openpyxl.load_workbook("/home/bjamshidikia/speedtest_1.xlsx")
sheet = wb.active
...
sheet["C2"] = "Times for 500 "
sheet["B2"] = "Number of records"
...
# Write data to the sheet
    sheet["C"+str(i+3)] = listtimes[i]
    sheet["B"+str(i+3)] = listrecords[i]

sheet["C"+str(str(len(listtimes)+3))] = statistics.mean(listtimes)
cellbg3 = sheet["C"+str(str(len(listtimes)+3))]
cellbg3.fill = PatternFill(start_color="ff0000",end_color="ff0000",fill_type="solid")

sheet["B"+str(str(len(listtimes)+3))] = "Average"
cellbg4 = sheet["B"+str(str(len(listtimes)+3))]
...
# Save the workbook
wb.save("/home/bjamshidikia/speedtest_1.xlsx")
wb.close()
