...
#    print("--------------")
    ...
    i += i
"""
wb = openpyxl.load_workbook("/home/bjamshidikia/speedtest_3.xlsx")
sheet = wb.active
...
sheet["G2"] = "Times for 500 "
sheet["F2"] = "Number of records"
...
# Write data to the sheet
    sheet["G"+str(i+3)] = listtimes[i]
    sheet["F"+str(i+3)] = listrecords[i]

sheet["G"+str(str(len(listtimes)+3))] = statistics.mean(listtimes)
cellbg3 = sheet["G"+str(str(len(listtimes)+3))]
cellbg3.fill = PatternFill(start_color="ff0000",end_color="ff0000",fill_type="solid")

sheet["F"+str(str(len(listtimes)+3))] = "Average"
cellbg4 = sheet["F"+str(str(len(listtimes)+3))]
...
# Save the workbook
wb.save("/home/bjamshidikia/speedtest_3.xlsx")
wb.close()
